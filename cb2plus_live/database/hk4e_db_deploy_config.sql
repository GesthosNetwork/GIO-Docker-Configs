...
(1, CONCAT('OVSWIN', @version), @region, '1'),
(2, CONCAT('OVSAndriod', @version), @region, '1');
...
(1, CONCAT('OVSWIN', @version),  '', '', '', '{\"sdkenv\": \"2\", \"checkdevice\": false, \"showexception\": false}'),
(2, CONCAT('OVSAndriod', @version),  '', '', '', '{\"sdkenv\": \"0\", \"checkdevice\": false, \"showexception\": false, \"downloadMode\": \"1\"}');
