...
(7,	CONCAT('OSCBWin', @version.beta), @region, '1'),
(8,	CONCAT('CNCBWin', @version.beta), @region, '1');
...
(7, CONCAT('OSCBWin', @version.beta), '', '', '{\"sdkenv\":2,\"checkdevice\":false,\"loadPatch\":false,\"showexception\":false,\"regionConfig\":\"pm|fk|add\",\"downloadMode\":0,\"cah\":false}', ''),
(8, CONCAT('CNCBWin', @version.beta), '', '', '{\"sdkenv\":0,\"checkdevice\":false,\"loadPatch\":false,\"showexception\":false,\"regionConfig\":\"pm|fk|add\",\"downloadMode\":0,\"cah\":false}', '');
...
(7, CONCAT('OSCBWin', @version.beta), @region, '{\"coverSwitch\":[4,7,8,9,18,19,21,22,27,28,29,31,32,36,37,38,40,42]}'),
(8, CONCAT('CNCBWin', @version.beta), @region, '{\"coverSwitch\":[4,7,8,9,18,19,21,22,27,28,29,31,32,36,37,38,40,42]}');
