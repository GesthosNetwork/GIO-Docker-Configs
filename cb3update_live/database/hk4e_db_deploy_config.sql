...
(7, CONCAT('CNINWin', @version), @region, '1')
(8, CONCAT('CNCBWin', @version), @region, '1');


CREATE TABLE `t_account_type_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `account_type` int(10) unsigned NOT NULL DEFAULT 0,
  `enable_login_pc` tinyint(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `account_type` (`account_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `t_account_type_config` (`id`, `account_type`, `enable_login_pc`) VALUES
(1, 1, 1);
...
CREATE TABLE `t_client_config` (
  ...
  `is_forbid_login` tinyint(4) NOT NULL DEFAULT 1,
  `checksum` varchar(512) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `version` (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='客户端配置';

INSERT INTO `t_client_config` (`id`, `version`, `name`, `stop_server_config_str`, `force_update_config_str`, `client_custom_config_str`, `is_forbid_login`, `checksum`) VALUES
(1, CONCAT('OSRELAndroid', @version), '', '', '', '{\"sdkenv\":\"2\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(2, CONCAT('OSRELWin', @version), '', '', '', '{\"sdkenv\":\"2\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(3, CONCAT('OSRELiOS', @version), '', '', '', '{\"sdkenv\":\"2\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(4, CONCAT('CNRELAndroid', @version), '', '', '', '{\"sdkenv\":\"0\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(5, CONCAT('CNRELWin', @version), '', '', '', '{\"sdkenv\":\"0\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(6, CONCAT('CNRELiOS', @version), '', '', '', '{\"sdkenv\":\"0\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(7, CONCAT('CNINWin', @version), '', '', '', '{\"sdkenv\":\"2\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, ''),
(8, CONCAT('CNCBWin', @version), '', '', '', '{\"sdkenv\":\"0\",\"checkdevice\":false,\"showexception\":false,\"downloadMode\":\"0\"}', 0, '');
